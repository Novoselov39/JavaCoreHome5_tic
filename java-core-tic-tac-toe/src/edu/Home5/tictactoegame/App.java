...
import edu.Home5.utils.ConsoleUtils;
import edu.Home5.utils.UncloseableInputStream;

public class App {

    static final Locale LOCALE = Locale.forLanguageTag("RU");
    static final Charset CHARSET = Charset.defaultCharset();
    static final Scanner scanner = new Scanner(UncloseableInputStream.wrap(System.in), String.valueOf(CHARSET));
